...
<head>
  ...
  <link rel="stylesheet" href="../Css/Administrador-Finanzas-Categorias.css">
</head>
<body>
  ...
  <div class="row">
    ...
    <div class="col-md-2 sidebar d-flex flex-column">
      ...
      <nav class="nav flex-column mt-4">
        <a class="nav-link active" href="Administrador-Finanzas-Categorias.php"><i class="bi bi-bar-chart"></i> Finanzas</a>
    ...
    <div class="col-md-10">
      ...
      <div class="section-titles-container">
        <a href="Administrador-Finanzas-Categorias.php" class="section-title active">Ventas por categoría</a>
        <a href="Administrador-Finanzas-Mesas.php" class="section-title ">Ventas por Mesa</a>
      </div>
