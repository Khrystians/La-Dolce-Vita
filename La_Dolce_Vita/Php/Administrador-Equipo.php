  ...
  <div class="row">
    ...
    <div class="col-md-10">
      ...
      <div class="container mt-5">
        <h2 class="text-center mt-5">Equipo de La Dolce Vita</h2>

        <div class="grid row row-cols-1 row-cols-md-3 g-4 mt-5">
          <!-- Tarjeta de miembro -->
          ...
          <div class="col">
            <div class="card text-center shadow-sm">
              <img src="https://randomuser.me/api/portraits/men/31.jpg" alt="Cristian Roman" class="card-img-top rounded-circle mx-auto mt-3" style="width: 120px; height: 120px;"> <!-- Imagen más grande -->
              <div class="card-body">
                <h4 class="card-title"><strong>Cristian Roman</strong></h4>
                <p class="card-text text-muted">Administración</p>
                <hr style="border: 1px solid #c94b4b;">
                <p class="card-text"><strong>Rol:</strong> Encargado de la gestión de inventarios y proveedores.</p>
                <p class="card-text"><strong>Horario:</strong> Lunes a Viernes, 10:00 AM - 6:00 PM</p>
                <a href="tel:+16517778888" class="d-block">(651) 777-8888</a>
                <a href="mailto:cristian.roman@company.com" class="d-block">cristian.roman@company.com</a>
              </div>
            </div>
          </div>
          ...
          <div class="col">
            <div class="card text-center shadow-sm">
              <img src="https://randomuser.me/api/portraits/women/32.jpg" alt="Coral Garcia" class="card-img-top rounded-circle mx-auto mt-3" style="width: 120px; height: 120px;"> <!-- Imagen más grande -->
              <div class="card-body">
                <h4 class="card-title"><strong>Coral Garcia</strong></h4>
                <p class="card-text text-muted">Administración</p>
                <hr style="border: 1px solid #c94b4b;">
                <p class="card-text"><strong>Rol:</strong> Responsable de la contabilidad y finanzas del restaurante.</p>
                <p class="card-text"><strong>Horario:</strong> Lunes a Viernes, 9:00 AM - 5:00 PM</p>
                <a href="tel:+16517778888" class="d-block">(651) 777-8888</a>
                <a href="mailto:coral.garcia@company.com" class="d-block">coral.garcia@company.com</a>
              </div>
            </div>
          </div>
          ...
          <div class="col">
            <div class="card text-center shadow-sm">
              <img src="https://randomuser.me/api/portraits/men/33.jpg" alt="Luis Da Silva" class="card-img-top rounded-circle mx-auto mt-3" style="width: 120px; height: 120px;"> <!-- Imagen más grande -->
              <div class="card-body">
                <h4 class="card-title"><strong>Luis Da Silva</strong></h4>
                <p class="card-text text-muted">Administración</p>
                <hr style="border: 1px solid #c94b4b;">
                <p class="card-text"><strong>Rol:</strong> Coordinador de eventos y relaciones públicas.</p>
                <p class="card-text"><strong>Horario:</strong> Martes a Sábado, 11:00 AM - 7:00 PM</p>
                <a href="tel:+16517778888" class="d-block">(651) 777-8888</a>
                <a href="mailto:luis.dasilva@company.com" class="d-block">luis.dasilva@company.com</a>
              </div>
            </div>
          </div>
          ...
          <div class="col">
            <div class="card text-center shadow-sm">
              <img src="https://randomuser.me/api/portraits/men/34.jpg" alt="Carlos Mendoza" class="card-img-top rounded-circle mx-auto mt-3" style="width: 120px; height: 120px;"> <!-- Imagen más grande -->
              <div class="card-body">
                <h4 class="card-title"><strong>Carlos Mendoza</strong></h4>
                <p class="card-text text-muted">Cocina</p>
                <hr style="border: 1px solid #c94b4b;"> <!-- Separador rojo -->
                <p class="card-text"><strong>Rol:</strong> Chef especializado en pastas y salsas italianas.</p>
                <p class="card-text"><strong>Horario:</strong> Lunes a Viernes, 9:00 AM - 5:00 PM</p>
                <a href="tel:+16517778888" class="d-block">(651) 777-8888</a>
                <a href="mailto:carlos.mendoza@company.com" class="d-block">carlos.mendoza@company.com</a>
              </div>
            </div>
          </div>

          <!-- Otra tarjeta (Servicio) -->
          <div class="col">
            <div class="card text-center shadow-sm">
              <img src="https://randomuser.me/api/portraits/women/35.jpg" alt="Sofia Lopez" class="card-img-top rounded-circle mx-auto mt-3" style="width: 120px; height: 120px;"> <!-- Imagen más grande -->
              <div class="card-body">
                <h4 class="card-title"><strong>Sofia Lopez</strong></h4>
                <p class="card-text text-muted">Servicio</p>
                <hr style="border: 1px solid #c94b4b;"> <!-- Separador rojo -->
                <p class="card-text"><strong>Rol:</strong> Encargada de atención al cliente y reservas.</p>
                <p class="card-text"><strong>Horario:</strong> Martes a Sábado, 10:00 AM - 6:00 PM</p>
                <a href="tel:+16517778888" class="d-block">(651) 777-8888</a>
                <a href="mailto:sofia.lopez@company.com" class="d-block">sofia.lopez@company.com</a>
              </div>
            </div>
          </div>
          ...
          <div class="col">
            <div class="card text-center shadow-sm">
              <img src="https://randomuser.me/api/portraits/men/36.jpg" alt="Diego Torres" class="card-img-top rounded-circle mx-auto mt-3" style="width: 120px; height: 120px;"> <!-- Imagen más grande -->
              <div class="card-body">
                <h4 class="card-title"><strong>Diego Torres</strong></h4>
                <p class="card-text text-muted">Servicio</p>
                <hr style="border: 1px solid #c94b4b;"> <!-- Separador rojo -->
                <p class="card-text"><strong>Rol:</strong> Supervisor de mesas y eventos especiales.</p>
                <p class="card-text"><strong>Horario:</strong> Miércoles a Domingo, 12:00 PM - 8:00 PM</p>
                <a href="tel:+16517778888" class="d-block">(651) 777-8888</a>
                <a href="mailto:diego.torres@company.com" class="d-block">diego.torres@company.com</a>
              </div>
            </div>
          </div>
        </div>
