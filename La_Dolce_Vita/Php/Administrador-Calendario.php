  ...
  <div class="row">
    ...
    <div class="col-md-2 sidebar d-flex flex-column">
      ...
      <nav class="nav flex-column mt-4">
        ...
        <a class="nav-link active" href="Administrador-Calendario.php"><i class="bi bi-calendar"></i> Calendario</a>
        <a class="nav-link" href="Administrador-Evento.php"><i class="bi bi-calendar-event"></i> Eventos</a>
    ...
    <div class="col-md-10">
      ...
      <div class="elfsight-app-5f8f98fc-a793-4b2a-ab02-969f7dc08946" data-elfsight-app-lazy style="margin-top: 5rem;"></div>
